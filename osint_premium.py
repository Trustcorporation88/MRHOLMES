...
NATIVE_SUITES = [
    ...
    },
    {
        ...
        "blurb": "Holehe, WhatsMyName, Maigret, theHarvester, subdomínios, httpx.",
        "kind": "analise",
        "osint_tool": "maigret",
    },
    {
        ...
        "icon": "🔓",
        "title": "Leaks",
        "blurb": "API oficial OSINT Leak se houver chave; senão atalho do dashboard.",
        "kind": "analise",
    },
    {
        "id": "rede",
...
FEATURED = [
    ...
    },
    {
        ...
        "icon": "🧾",
        "tier": "API / Conta",
        "tagline": "Busca oficial no menu Leaks quando OSINTLEAK_API_KEY está no Railway.",
        "delivers": [
            "Consulta in-app (email, username, telefone, domínio, IP, nome)",
            "stealerlogs=false — senhas e cookies são omitidos na tela",
            "Sem chave: só o dashboard oficial, sem scrape",
        ],
        "complements": "WhatsMyName/Maigret cobrem username. Holehe cobre contas de email (≈ Epieos).",
        "requires": "Variable Railway OSINTLEAK_API_KEY (Dashboard → API Settings). IP whitelist opcional.",
...
PLAYBOOKS = [
    ...
    },
    {
        ...
        "steps": [
            {
                "label": "Username (WhatsMyName nativo)",
                "detail": "Lista aberta WebBreacher — sem abrir whatsmyname.app",
                "kind": "native",
                "page": "OSINT Avançado",
                "osint_tool": "whatsmyname",
            },
            {
            ...
            {
                "label": "Holehe (≈ Epieos)",
                "detail": "Onde o email tem conta pública — sem raspar epieos.com",
                "kind": "native",
                "page": "OSINT Avançado",
                "osint_tool": "holehe",
            },
    ...
    },
    {
        ...
        "steps": [
            ...
            {
                "label": "Truecaller (site oficial)",
                "detail": "Sem API de busca reversa OSINT — o Holmes não raspa",
                "kind": "external",
    ...
    },
    {
        ...
        "steps": [
            ...
            {
                "label": "Menu Leaks",
                "detail": "API OSINT Leak se OSINTLEAK_API_KEY existir; senão dashboard",
                "kind": "native",
                "page": "Leaks",
            },
        ],
