...
perfil, número de processo judicial ou URL (inclusive `.onion`)** — o tipo é detectado sozinho, todas as fontes aplicáveis rodam em
...
- **126 fontes registradas:** 24 automáticas, 88 abrindo **já pesquisadas** no
...
- **Rastreamento de site (opt-in):** quando você já tem a URL, percorre o site
  e extrai e-mail, telefone, **endereço de cripto** e perfis sociais. Funciona
  em clearnet e `.onion` (via Tor). O conteúdo das páginas não é armazenado.
